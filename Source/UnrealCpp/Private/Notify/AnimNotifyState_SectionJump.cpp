...
void UAnimNotifyState_SectionJump::NotifyBegin(USkeletalMeshComponent* MeshComp,
...
void UAnimNotifyState_SectionJump::NotifyEnd(USkeletalMeshComponent* MeshComp, 
	UAnimSequenceBase* Animation, 
	const FAnimNotifyEventReference& EventReference)
{
